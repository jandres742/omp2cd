...
//===========================================================
{
  ...
  const int64_t * restrict IJ = (int64_t*)IJ_in;
  //===========================================================
  ...
  */
  ...
  OMP("omp parallel shared(err)") 
  {
    ...
    for (k = 0; k < 2*nedge; k+=2) 
    {
      ...
      { 
        //===========================================================
        fprintf(stderr, "k = %d, IJ[k] = %ld, IJ[k+1] = %ld \n", k, IJ[k], IJ[k+1]);
        fprintf(stderr, "bfs_tree[%d] >= 0 && bfs_tree[%d] < 0: %ld >= 0 && %ld < 0 \n", i, j, bfs_tree[i], bfs_tree[j]);
        //===========================================================
