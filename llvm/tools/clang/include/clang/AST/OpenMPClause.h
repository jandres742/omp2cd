...
/// \brief This represents 'codelet' clause in the '#pragma omp ...' directive.
///
/// \code
/// #pragma omp for codelet
/// \endcode
/// In this example directive '#pragma omp for' has 'codelet' clause.
///
class OMPCodeletClause : public OMPClause {
public:
  /// \brief Build 'codelet' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  ///
  OMPCodeletClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(OMPC_codelet, StartLoc, EndLoc) {}

  /// \brief Build an empty clause.
  ///
  OMPCodeletClause()
      : OMPClause(OMPC_codelet, SourceLocation(), SourceLocation()) {}

  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == OMPC_codelet;
  }
